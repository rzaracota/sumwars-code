...
find_path(OGRE_INCLUDE_DIR NAMES OgreRoot.h
  HINTS ${OGRE_CONFIG_INCLUDE_DIR} ${OGRE_INC_SEARCH_PATH} ${OGRE_FRAMEWORK_INCLUDES} ${OGRE_PKGC_INCLUDE_DIRS} ${ENV_OGRE_HOME}/OgreMain/include
  PATH_SUFFIXES "OGRE"
)
...
macro(ogre_find_component COMPONENT HEADER)
  ...
  find_path(OGRE_${COMPONENT}_INCLUDE_DIR 
    NAMES ${HEADER} 
    HINTS ${OGRE_INCLUDE_DIRS} ${OGRE_PREFIX_SOURCE} ${ENV_OGRE_HOME}/Components/${COMPONENT}/include 
    PATH_SUFFIXES ${COMPONENT} include OGRE/${COMPONENT} Components/${COMPONENT}/include
  )
