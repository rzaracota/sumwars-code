...
public:
	 ...
	 */
	virtual void InitializeSecurity(char *pubKeyE, char *pubKeyN, char *privKeyP, char *privKeyQ ) = 0;
	 ...
	 *
	 */
	virtual bool RPC( char* uniqueID, char *data, unsigned int bitLength, PacketPriority priority, PacketReliability reliability, char orderingChannel, PlayerID playerId, bool broadcast, bool shiftTimestamp ) = 0;
	 ...
	 * If you set it to 0 then the disconnection notification probably won't arrive
	 */
	virtual void CloseConnection( PlayerID target, bool sendDisconnectionNotification, unsigned int blockDuration ) = 0;
	...
	*/
	 ...
	 */
	virtual void SetOfflinePingResponse( char *data, const unsigned int length ) = 0;
