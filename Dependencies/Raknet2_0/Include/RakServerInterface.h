...
public:
	 ...
	 */
	virtual bool Start( unsigned short AllowedPlayers, unsigned int connectionValidationInteger, int threadSleepTimer, unsigned short port ) = 0;
	 ...
	 * 
	 */
	virtual void InitializeSecurity( char *pubKeyE, char *pubKeyN ) = 0;
