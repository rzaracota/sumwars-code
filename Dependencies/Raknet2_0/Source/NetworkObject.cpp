...
/**
* @file 
* @brief NetworkObject Implementation 
*
...
ObjectIDNode::ObjectIDNode( unsigned short ObjectID, NetworkObject *Object )
{
	objectID = ObjectID;
	object = Object;
}
...
NetworkObject* GET_OBJECT_FROM_ID( unsigned short x )
{
	if ( x == UNASSIGNED_OBJECT_ID )
		return 0;

	ObjectIDNode *n = NetworkObject::IDTree.get_pointer_to_node( ObjectIDNode( ( x ), 0 ) );
