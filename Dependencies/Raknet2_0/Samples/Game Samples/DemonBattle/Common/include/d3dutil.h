...
typedef struct  {
   ...
   D3DMATERIAL9       pMeshMaterials[8];
   LPDIRECT3DTEXTURE9 pMeshTextures[8];
   LPD3DXMESH          pMesh;

} X3DMODELL;


void GetClickPos (D3DXVECTOR3& rayDir, D3DXVECTOR3& rayOrg, POINT ptCursor);
...
BOOL RenderX(X3DMODELL& X, LPDIRECT3DTEXTURE9&) ;
...
extern D3DCAPS9          m_d3dCaps;           // Caps for the device
extern D3DSURFACE_DESC   m_d3dsdBackBuffer;   // Surface desc of the backbuffer
extern HWND              m_hWnd;              // The main app window
extern HINSTANCE		  m_hInstance; // Made global by me!
