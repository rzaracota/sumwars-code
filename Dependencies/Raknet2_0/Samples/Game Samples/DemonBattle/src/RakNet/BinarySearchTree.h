...
template <class AVLBalancedBinarySearchTreeType>
class AVLBalancedBinarySearchTree : public BinarySearchTree<AVLBalancedBinarySearchTreeType>
{
	public:

			
	AVLBalancedBinarySearchTree() {BinarySearchTree<AVLBalancedBinarySearchTreeType>::BinarySearchTree<AVLBalancedBinarySearchTreeType>();}
	~AVLBalancedBinarySearchTree();
	void add(const AVLBalancedBinarySearchTreeType& input);
	void del(const AVLBalancedBinarySearchTreeType& input);
	BinarySearchTree<AVLBalancedBinarySearchTreeType>& operator= (BinarySearchTree<AVLBalancedBinarySearchTreeType>& original_copy) {return BinarySearchTree<AVLBalancedBinarySearchTreeType>::operator= (original_copy);}

	private:
		void balance_tree(node* current, bool rotateOnce);
		void rotate_right(node *C);
		void rotate_left(node* C);
		void double_rotate_right(node *A);
		void double_rotate_left(node* A);
		bool right_higher(node* A);
		bool left_higher(node* A);
};

template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::balance_tree(node* current, bool rotateOnce)
{
...
template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::add(const AVLBalancedBinarySearchTreeType& input)
{
	node* current = BinarySearchTree<AVLBalancedBinarySearchTreeType>::add(input);
	balance_tree(current, true);
}

template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::del(const AVLBalancedBinarySearchTreeType& input)
{
	node* current = BinarySearchTree<AVLBalancedBinarySearchTreeType>::del(input);
	balance_tree(current,false);

}

template <class AVLBalancedBinarySearchTreeType>
bool AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::right_higher(node *A)
{
	if (A==0) return false;
...
template <class AVLBalancedBinarySearchTreeType>
bool AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::left_higher(node *A)
{
	if (A==0) return false;
...
template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::rotate_right(node *C)
{
	node *A, *B, *D;
	/*
		RIGHT ROTATION
...
template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::double_rotate_right(node *A)
{
...
template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::rotate_left(node *C)
{
	node *A, *B, *D;
	/*
		RIGHT ROTATION
...
template <class AVLBalancedBinarySearchTreeType>
void AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::double_rotate_left(node *A)
{
...
template <class AVLBalancedBinarySearchTreeType>
AVLBalancedBinarySearchTree<AVLBalancedBinarySearchTreeType>::~AVLBalancedBinarySearchTree()
{
	clear();
}
...
template <class BinarySearchTreeType>
const unsigned long BinarySearchTree<BinarySearchTreeType>::height(node* starting_node)
{
...
template <class BinarySearchTreeType>
const unsigned long BinarySearchTree<BinarySearchTreeType>::height_recursive(node* current)
{
...
template <class BinarySearchTreeType>
void BinarySearchTree<BinarySearchTreeType>::fix_tree(node* current)
{
...
template <class BinarySearchTreeType>
void BinarySearchTree<BinarySearchTreeType>::display_postorder_recursive(node* current, BinarySearchTreeType* return_array,unsigned long& index)
{
	if (current->left!=0)
